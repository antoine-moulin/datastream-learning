        ...
        for d in range(0, batchD):
            ...
            for it in range(0, 100):
                ...
                gammad = self._alpha + expElogthetad * \
                    n.dot(list(cts) / phinorm, expElogbetad.T)
...
#         return((gamma, sstats))
    ...
    def update_lambda_docs(self, docs, renew_rho=False):
        """
    ...
    def update_lambda(self, wordids, wordcts, renew_rho = False):
        """
        First does an E step on the mini-batch given in wordids and
        wordcts, then uses the result of that E step to update the
        variational parameter matrix lambda.
    ...
    def reset_time(self):
        """
        Reset the gradient descent "eta" parameter to its initial state
        """
